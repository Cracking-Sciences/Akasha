...
namespace Akasha {
	...
	public:
		JSEngine() {}
		~JSEngine() {}
		bool loadFunction(const std::string& source_code) { return true; }
		bool callFunction(const std::array<double, 8>& args_array, std::vector<double>& result_vector, juce::String& info) { return true; }
	};
}
#endif
...
namespace Akasha {
	...
	public:
		...
		bool callFunction(const std::array<double, 8>& args_array, std::vector<double>& result_vector, juce::String& info) {
