...
namespace Akasha {
    void printFileTree(const juce::File& directory, int indent = 0) {
    ...
    void packDirectory(const juce::File& sourceDir, const juce::File& outputFile) {
    ...
    void unpackToDirectory(const juce::File& packedFile, const juce::File& outputDir) {
